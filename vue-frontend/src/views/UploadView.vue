<template>
    <div style="text-align: center">
        ...
        <div class="mb-3">Upload your video:</div>

        <div class="input-group mb-3">
            <input
                @change="previewFiles(1)"
                type="file"
                ref="vid"
                class="form-control"
                data-classButton="btn btn-primary"
                data-buttonText="Video"
                aria-label="Default"
                aria-describedby="inputGroup-sizing-default"
                accept=".mp4"
            />
        ...
        <div class="mb-3">Upload your thumbnail:</div>

        <div class="input-group mb-3">
            <input
                @change="previewFiles(2)"
                type="file"
                ref="thumb"
                class="form-control"
                data-classButton="btn btn-primary"
...
export default {
    ...
    methods: {
        UploadRequest(title, desc, video, thumb) {
            ...
            axios.post(this.backhost + "/api/videos/", formData, { headers }).then((res) => {
                alert("Uploaded!");
